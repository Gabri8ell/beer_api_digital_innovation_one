...
import one.digitalinnovation.beerstock.exception.BeerStockExcededException;
import one.digitalinnovation.beerstock.exception.BeerStockInsufficient;
...
//----------------------------------DECREMENT-----------------------------------------------------------------------
    ...
    void whenPATCHIsCalledToDecrementLowerThanZeroThenBadRequestStatusIsReturned() throws Exception {
        ...
        when(beerService.decrement(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerStockInsufficient.class);

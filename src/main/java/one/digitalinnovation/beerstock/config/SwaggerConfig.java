...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Gabriel Anjos";
    private static final String CONTACT_GITHUB = "https://github.com/Gabri8ell";
    private static final String CONTACT_EMAIL = "gbr192008@hotmail.com";
